          ...
          <div className='modal mt-20'>
            <form className='form'>
              ...
              <p className='description'>
                Discover Urban Adventure: Shop our Stylish Graphic T-Shirt Now!{' '}
              </p>
              ...
              <div className='benefits'>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <span>
                      {' '}
                      t-shirt ensures a soft and breathable feel against your skin, keeping you
              ...
              <div className='benefits'>
                ...
                <ul>
                  <li>
                    <span>
                      ⭐⭐⭐⭐⭐ "Love the design! It's my go-to t-shirt for casual outings."
                    </span>
                  </li>
                  <li>
                    <span>
                      {' '}
                      ⭐⭐⭐⭐ "The fabric feels great, and the print is fantastic. Highly
                      recommend!"
                    </span>
                  </li>
                  <li>
                    <span>
                      ⭐⭐⭐⭐ "Super comfortable and fits perfectly. Will definitely buy more!"
                    </span>
                  </li>
                </ul>
              </div>
