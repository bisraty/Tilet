import img1 from '../assets/Images/canvas (1).png'
import img2 from '../assets/Images/canvas (2).png'
import img3 from '../assets/Images/canvas (3).png'
...
export var data = [
  ...
  {title: 'Jak Tshirt ', price: '200birr', icon: img2},
